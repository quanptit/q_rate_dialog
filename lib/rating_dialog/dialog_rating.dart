...
void showDialogRating(BuildContext context, {required String linkContract, String? appStoreId}) async {
...
class _DialogRatingState extends State<DialogRating> {
  ...
  void btnSubmitClick() {
    if (ratingValue == 0) {
      L.d("ratingValue 0");
      UiUtils.showSnackBar(LanguagesUtils.getString("not_given_star", "You have not given stars!"));
      return;
    }
    if (ratingValue > 4.5) {
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return GeneralDialog(
      ...
      child: Center(
        child: Card(
          margin: EdgeInsets.symmetric(horizontal: isSmall ? 16 : 32, vertical: isSmall ? 16 : 32),
          child: Padding(
            padding: EdgeInsets.symmetric(horizontal: isSmall ? 12 : 16, vertical: 20),
            child: child,
          ),
        ),
      ),
        ...
        children: [
          ...
          Text(
              LanguagesUtils.getString(
                  "rate_msg2", "Please help us out - It'd be really helpful if you rate us on store."),
          ...
          Wrap(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () {
                  RouteUtils.backPress(context: context);
                  AppRateUtils.openStoreForReview(appStoreId: widget.appStoreId);
                  AppRateUtils.setUserHasGoStoreRateApp();
                },
                child: Text(
                  LanguagesUtils.getString("yes_sure", "Yes, sure!").toUpperCase(),
  ...
  Widget _buildRateStateNotGood(BuildContext context) {
    ...
    return Container(
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          Text(LanguagesUtils.getString("How_make_better", "How can we make it better?"),
              style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
          E.sizeBoxHeight_16,
          InkWellButton(
            onTap: () => OpenUrlUtils.openUrlWithExternalApplication(linkContract),
            child: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                Padding(
                  padding: const EdgeInsets.only(top: 12, bottom: 6),
                  child: Text(LanguagesUtils.getString("please_contact_us", "Please contact us"),
          ...
          ElevatedButton.icon(
            ...
            label: Text(LanguagesUtils.getString("Close", "Close").toUpperCase()),
  ...
  Widget _buildRateStateNone(BuildContext context) {
    return Container(
      child: Column(
        ...
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          Image.asset("packages/q_rate_dialog/imgs/ic_rate_dialog.png", width: 64, height: 64),
          E.sizeBoxHeight_16,
          Text(LanguagesUtils.getString("rate_msg1", "How was your experience with us?"),
              style: T.textTheme(context).headlineSmall, textAlign: TextAlign.center),
          E.sizeBoxHeight_16,
          Center(
          ...
          Text("${ratingValue.toInt()}/5",
              style: T
                  .textTheme(context)
                  .headlineSmall
                  ?.copyWith(color: T.getColors(context).primary, fontWeight: FontWeight.bold),
              textAlign: TextAlign.center),
          E.sizeBoxHeight_32,
          Wrap(
            direction: Axis.horizontal,
            ...
            children: [
              ...
              TextButton(
                ...
                child: Text(
                  ...
                  style: TextStyle(fontSize: 18, color: T.getColors(context).primary),
                ),
              ),
            ],
          )
